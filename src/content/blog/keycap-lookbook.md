---
title: "45 flat-profile PBT keycap sets, sorted by aesthetic (cyberpunk, pastel, ukiyo-e)"
description: "45 PBT keycap sets in flat and uniform profiles, sorted into cyberpunk, pastel and ukiyo-e. Every listing verified in stock. No affiliate links."
pubDate: 2026-07-05
...
The end result is a shoppable lookbook of 45 keycap sets, sorted into three looks. PBT plastic only, flat/uniform profiles only (DSA, SA, XDA, MOA, MDA, KAT), prices captured on a single day (they drift, so treat them as "as of then"). You can shop straight off it.

**Why we're publishing this:** if you are shopping for keycaps, the buy buttons are real and the links are clean — canonical store URLs, no affiliate wrappers, no trackers.

**And if you want a lookbook of your own:** the thing that built this page is a public skill called [`shopping-lookbook`](https://github.com/DrewHoo/shopping-lookbook). You, or your agent, can install it and point it at any aesthetic or category — furniture, plants, audiobooks, whatever — and get back a page like this one. More on that at the bottom.
...
## Cyberpunk keycaps: bi-lighting and neon-noir
...
## Pastel keycaps: cottagecore, witchy, celestial
...
## Ukiyo-e keycaps: game art and woodblock prints
...
## Alice layout and split-spacebar keycaps for a Keychron Q8
...
## How to build your own shoppable lookbook
